...
export default function UpdateListing() {
  ...
  useEffect(() => {
    // we got the async behaviour by calling the function outside the body but inside the hook 
    const fetchListing = async () => {
      // because we call it listingId here (
  ...
  const handleImageSubmit = (e) => {
    // we don't wrote the e.preventDefault() here because we are not makign the use of the form and the button is not in th form 
