...
export const getListings = async (req, res, next) => {
    try {
        ...
        // When the param is missing (undefined) or false, match both true and false.
        ...
        if (furnished === undefined || furnished === 'undefined' || furnished === 'false') {
            furnished = {$in: [false, true]}
        }

        let parking = req.query.parking

        if(parking === undefined || parking === 'undefined' || parking === 'false') {
